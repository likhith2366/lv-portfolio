...
export default function NovaGlow({ hue = 0, hoverIntensity = 0.2, rotateOnHover = true }) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const handleMouseMove = (e) => {
        ...
        const uvX = ((x - cx) / size) * 2;
        const uvY = ((y - cy) / size) * 2;
      ...
      console.error('Failed to initialize NovaGlow WebGL:', err);
    }
